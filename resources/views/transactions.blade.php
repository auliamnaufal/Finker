    ...
    <div class="pb-20">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div id="tabContentExample">
                <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800 space-y-4 divide-y divide-gray-200" id="all" role="tabpanel" aria-labelledby="all-tab">
                ...
                <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800 space-y-4 divide-y divide-gray-200" id="expenses" role="tabpanel" aria-labelledby="expenses-tab">
                    @foreach (range(1, 3) as $i)
                        <div class="grid grid-cols-6 items-center pt-4">
                            <div class="w-12 h-12 bg-pink-300 rounded-lg flex justify-center items-center ">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 text-pink-500">
                ...
                <div class="hidden p-4 rounded-lg bg-gray-50 dark:bg-gray-800 space-y-4 divide-y divide-gray-200" id="incomes" role="tabpanel" aria-labelledby="incomes-tab">
                    @foreach (range(1, 3) as $i)
